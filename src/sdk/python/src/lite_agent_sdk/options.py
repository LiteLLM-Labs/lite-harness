...
class ClaudeAgentOptions:
    ...
    # lite-harness extension: which agent runtime the server should use.
    harness: str = "claude"
    ...
    def to_wire(self) -> dict[str, Any]:
        ...
        ``Path`` values are stringified. ``harness`` is excluded because it is
        sent as a top-level ``session/new`` param, not inside ``options``.
        """
